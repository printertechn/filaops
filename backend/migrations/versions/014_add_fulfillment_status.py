...
def upgrade():
    ...
    # Old 'pending' → 'draft' (not yet paid)
    # Old 'confirmed' → 'confirmed' (paid, ready for production)
    # Old 'in_production' → 'in_production' (manufacturing)
    # Old 'quality_check' → 'ready_to_ship' (QC is now at WO level)
